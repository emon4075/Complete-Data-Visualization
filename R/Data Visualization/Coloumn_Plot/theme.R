...
ggplot(data_frame, aes(x = student, y = GPA)) + # Initialize the plot with the data frame and map the 'student' column to the x-axis and 'GPA' column to the y-axis
    ...
    scale_fill_viridis_d("Students") + # Apply a discrete Viridis color scale to the fill colors, with the legend labeled "Students"
    ...
    theme_classic() # Apply the classic theme to the plot for a clean and minimalistic look
